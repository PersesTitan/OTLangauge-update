...
public class ApplyTool {
    ...
    protected static Object subReplace(String line, boolean isFirst) {
...
//                yield Types.toObject(line.strip(), isFirst);
    ...
    protected static Object method(String type, String line) {
    ...
    // String -> Map
    protected static Object mapTool(Types types, String line) {
    ...
    // String -> Set
    protected static Object setTool(Types types, String line) {
    ...
    // String ->
    protected static Object listTool(Types types, String line) {
